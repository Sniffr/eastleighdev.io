...
import ad01 from "../../assets/images/furniture/product-ad/01.jpg";
import ad02 from "../../assets/images/furniture/product-ad/02.jpg";
import fun01 from "../../assets/images/furniture/01.png";
    ...
    return (
      <>
        ...
        <div className="page-content">
            ...
            <div className="container-fluid">
              <Row>
                <div className="col-12 col-lg-6">
                  <div className="position-relative rounded overflow-hidden">
                    ...
                    <div className="position-absolute top-0 pl-5 pt-5">
                      <h6 className="text-dark">Eastleigh Furniture</h6>
                      {/* Heading */}
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={ad02} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-0 pl-5 pt-5">
          ...
          {/*hot deal end*/}
          {/*product ad start*/}
           <section style={{ backgroundImage: `url(${fun01})` , backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
              <Container>
                <Row>
                  <div className="col-12 col-lg-6">
                    <h4 className="mb-3"><span className="text-primary">2022</span> Collection</h4>
