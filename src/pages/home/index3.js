...
import productad05 from "../../assets/images/product-ad/05.jpg";
import ad01 from "../../assets/images/product-ad/01.jpg";
import ad07 from "../../assets/images/product-ad/07.jpg";
        ...
        <div className="page-content">
          ...
          <section className="bg-light pt-11 mt-n11">
            <Container>
              <Row>
                <Col>
                  <div className="bg-white rounded p-6 py-11 bg-pos-rt bg-sm-none" style={{ backgroundImage: `url(${productad05})` }}>
                    <Row>
            ...
            <div className="container-fluid">
              <Row>
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={ad07} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-50 pl-5">
                      <h6 className="text-dark">2022 Collection</h6>
                      {/* Heading */}
