...
import ad03 from "../../assets/images/electronic/product-ad/03.jpg";
import ad02 from "../../assets/images/electronic/product-ad/02.jpg";
import ad01 from "../../assets/images/electronic/product-ad/01.jpg";
            ...
            <Container>
              <Row>
                ...
                <div className="col-12 col-lg-4 col-md-12 mt-5 mt-lg-0">
                  <div className="position-relative rounded overflow-hidden">
                    {/* Background */}
                    <img className="img-fluid hover-zoom" src={ad03} alt="" />
                    {/* Body */}
                    <div className="position-absolute top-50 pl-5">
