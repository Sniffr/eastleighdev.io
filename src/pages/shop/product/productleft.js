                  ...
                  <Row>
                    ...
                    <div className="col-lg-6 col-12 mt-5 mt-lg-0">
                      <div className="product-details">
                        ...
                        </div> <span className="product-price h4">Kes{SelectedProduct.price}  <del className="text-muted h6">Kes{SelectedProduct.salePrice}</del></span>
                          ...
                          <TabPane tabId="1" className="fade show" active>
                            <Row className="align-items-center">
                              <div className="col-md-5">
                                <img className="img-fluid w-100" src={SelectedProduct.pictures[0]} alt="" />
                              </div>
                              ...
                              <div className="media d-block d-md-flex">
                                ...
                                <div className="media-body">
                                  <div className="d-flex align-items-center">
                                    ...
                                    <small className="mx-3 text-muted">March 15, 2022</small>
                                    <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                                    </div>
                                  </div>
                                  <p className="mb-0 mt-3">Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi.</p>
                              ...
                              <div className="media d-block d-md-flex">
                                ...
                                <div className="media-body">
                                  <div className="d-flex align-items-center">
                                    ...
                                    <small className="mx-3 text-muted">February 26, 2022</small>
                                    <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                                    </div>
                                  </div>
                                  <p className="mb-0 mt-3">Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi.</p>
                  ...
                  >
                    <div className="item">
                      ...
                      <div className="card product-card">
                        ...
                        <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
                          <img className="card-img-top card-img-back" src={main02} alt="..." />
                          <img className="card-img-top card-img-front" src={main01} alt="..." />
                        </Link>
                        <div className="card-info">
                          <div className="card-body">
                            <div className="product-title"><Link className="link-title" to="/product-single-left/Woman/1">Women Lather Jacket</Link>
                            </div>
                            <div className="mt-1"> <span className="product-price"><del className="text-muted">Kes 3500</del> Kes 2500</span>
                              <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="item">
                      ...
                      <div className="card product-card">
                        ...
                        <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
                          <img className="card-img-top card-img-back" src={main12} alt="..." />
                          <img className="card-img-top card-img-front" src={main11} alt="..." />
                        </Link>
                        <div className="card-info">
                          <div className="card-body">
                            <div className="product-title"><Link className="link-title" to="/product-single-left/Woman/1">Bright Hipster Cloth</Link>
                            </div>
                            <div className="mt-1"> <span className="product-price"><del className="text-muted">Kes 4200</del> Kes 3700</span>
                              <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="item">
                      ...
                      <div className="card product-card">
                        ...
                        <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
                          <img className="card-img-top card-img-back" src={main14} alt="..." />
                          <img className="card-img-top card-img-front" src={main13} alt="..." />
                        </Link>
                        <div className="card-info">
                          <div className="card-body">
                            <div className="product-title"><Link className="link-title" to="/product-single-left/Woman/1">Men's Brand Tshirts</Link>
                            </div>
                            <div className="mt-1"> <span className="product-price"><del className="text-muted">Kes 1800</del> Kes 1500</span>
                              <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="item">
                      ...
                      <div className="card product-card">
                        ...
                        <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
                          <img className="card-img-top card-img-back" src={main10} alt="..." />
                          <img className="card-img-top card-img-front" src={main09} alt="..." />
                        </Link>
                        <div className="card-info">
                          <div className="card-body">
                            <div className="product-title"><Link className="link-title" to="/product-single-left/Woman/1">Luxury Fashion Bag</Link>
                            </div>
                            <div className="mt-1"> <span className="product-price"><del className="text-muted">Kes 1900</del> Kes1300</span>
                              <div className="star-rating"><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" /><i className="las la-star" />
                              </div>
                            </div>
                          </div>
