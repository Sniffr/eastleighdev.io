                ...
                <Row>
                            ...
                            <tr>
                              <td>
                                <div className="media align-items-center">
                                  <Link to="/">
                                    <img className="img-fluid" src={CartItem.ProductImage} style={{ height: '100px' }} alt="" />
                                  </Link>
                              ...
                              <td> <span className="product-price text-muted">
                                Kes{CartItem.Rate.toLocaleString(navigator.language, { minimumFractionDigits: 0 })}
                              </span>
                              </td>
                              <td>
                              ...
                              <td> <span className="product-price text-dark font-w-6">
                                Kes{(CartItem.Rate * CartItem.Qty).toLocaleString(navigator.language, { minimumFractionDigits: 0 })}
                              </span>
                  ...
                  <div className="col-lg-4 pl-lg-5 mt-8 mt-lg-0">
                    <div className="shadow rounded p-5">
                      ...
                      <div className="d-flex justify-content-between align-items-center border-bottom py-3"> <span className="text-muted">Subtotal</span>  <span className="text-dark">Kes{this.GetCartItems().reduce((fr, CartItem) => fr + (CartItem.Qty * CartItem.Rate), 0).toLocaleString(navigator.language, { minimumFractionDigits: 0 })}</span>
                      </div>
                      <div className="d-flex justify-content-between align-items-center border-bottom py-3"> <span className="text-muted">Tax</span>  <span className="text-dark">Kes 00.00</span>
                      </div>
                      <div className="d-flex justify-content-between align-items-center pt-3 mb-5"> <span className="text-dark h5">Total</span>  <span className="text-dark font-weight-bold h5">Kes{this.GetCartItems().reduce((fr, CartItem) => fr + (CartItem.Qty * CartItem.Rate), 0).toLocaleString(navigator.language, { minimumFractionDigits: 0 })}</span>
                      </div>
