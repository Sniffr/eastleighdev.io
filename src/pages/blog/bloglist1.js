...
import thumb01 from "../../assets/images/blog/blog-thumb/01.jpg";
import thumb02 from "../../assets/images/blog/blog-thumb/02.jpg";
import thumb03 from "../../assets/images/blog/blog-thumb/03.jpg";
import productad04 from "../../assets/images/product-ad/04.jpg";
                                    ...
                                    <div className="card border-0 bg-transparent">
                                        ...
                                        <div className="card-body px-0 pb-0">
                                            ...
                                            <h2 className="h5 font-w-6 mt-3">
                                                <Link className="link-title" to="/blog-single">When it’s Rainy outdoors gifts but you feel like eastleigh</Link>
                                            </h2>
                                            <Link className="btn btn-outline-dark" to="/blog-single">Read Details</Link>
                                        </div>
                                        <div />
                                        ...
                                        <div className="widget border-bottom mb-8 pb-8">
                                            ...
                                            <article>
                                                <div className="media align-items-center">
                                                    <img src={thumb01} className="mr-3" alt="..." />
                                            ...
                                            <article className="mt-5">
                                                <div className="media align-items-center">
                                                    <img src={thumb02} className="mr-3" alt="..." />
                                                    <div className="media-body">
                                                        <h5 className="h6">
                                            ...
                                            <article className="mt-5">
                                                <div className="media align-items-center">
                                                    <img src={thumb03} className="mr-3" alt="..." />
                                                    <div className="media-body">
                                                        <h5 className="h6">
                            ...
                            <span className="badge badge-primary-soft text-dark font-weight-normal p-2 badge-pill ml-2">32</span>
                                        ...
                                        <div className="widget bg-light p-4 text-center rounded">
                                            ...
                                            <div className="position-relative mt-4">
                                                <img className="img-fluid" src={productad04} alt="" />
