            ...
            <Col lg={3} sm={6} >
              <div className="d-flex">
                ...
                <div>
                  ...
                  <p className="mb-0">Free Delivery in Nairobi </p>
                </div>
              </div>
            </Col>
            <Col lg={3} sm={6} className="mt-3 mt-sm-0">
              <div className="d-flex">
                ...
                <div>
                  ...
                  <p className="mb-0">You Order We Deliver </p>
                </div>
              </div>
            </Col>
            <Col lg={3} sm={6} className="mt-3 mt-lg-0">
              <div className="d-flex">
                ...
                <div>
                  ...
                  <p className="mb-0">Offering Cash With Order and Cash on Delivery</p>
                </div>
              </div>
            </Col>
            <Col lg={3} sm={6} className="mt-3 mt-lg-0">
              <div className="d-flex">
                ...
                <div>
                  <h5 className="mb-1">24/7 Support & Services</h5>
                  <p className="mb-0">Place your Order at anytime </p>
                </div>
              </div>
            </Col>
          </Row>
