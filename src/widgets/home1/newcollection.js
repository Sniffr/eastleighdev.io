    ...
    return (
      <>
        <Row>
          ...
          {Productlist.map((productdata, index) => (index < 12) ?
            <Col xl={3} lg={4} md={6} key={index}>
              ...
              <div className="card product-card">
                ...
                <Link className="card-img-hover d-block" to={`/product-single-left/${productdata.category}/${productdata.id}`}>
                  <img className="card-img-top card-img-back" src={productdata.pictures[0]} alt="..." />
                  <img className="card-img-top card-img-front" src={productdata.pictures[1]} alt="..." />
                </Link>
                <div className="card-info">
                  <div className="card-body">
                    <div className="product-title"><Link to="/product-single" className="link-title">{productdata.name}</Link>
                    </div>
                    <div className="mt-1"> <span className="product-price"><del className="text-muted">Kes {productdata.price}</del> Kes {productdata.salePrice}</span>
            ...
            <Row className="align-items-center">
              <div className="col-lg-5 col-12">
                {(viewproduct.pictures && viewproduct.pictures.length > 0) ?
                  <img className="img-fluid rounded" src={viewproduct.pictures[0]} alt="" />
                  : null}
              </div>
              <div className="col-lg-7 col-12 mt-5 mt-lg-0">
                <div className="product-details">
                  ...
                  </div> <span className="product-price h4">Kes{viewproduct.salePrice}<del className="text-muted h6">Kes{viewproduct.price}</del></span>
