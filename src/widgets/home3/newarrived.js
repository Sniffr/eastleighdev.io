        ...
        return (
            <Row>
                <div className="col-lg-4 col-md-6">
                    <h5 className="mb-5 font-w-5"><span className="text-primary">—</span> New Arrival</h5>
                        ...
                        (index < 4) ?
                            ...
                            <div className="media align-items-center mb-4">
                                <Link className="d-block mr-3" to={`/product-single-left/${productdata.category}/${productdata.id}`}>
                                    <img className="rounded" src={productdata.pictures[0]} alt="Product" width={100} />
                                </Link>
                                <div className="media-body">
                                    ...
                                    <span className="product-price"><del className="text-muted">{productdata.price}</del> Kes {productdata.salePrice}</span>
                                </div>
                            </div>
                            : null
                    ))}
