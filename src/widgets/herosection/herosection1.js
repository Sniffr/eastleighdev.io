...
import bg06 from "../../assets/images/bg/06.jpg";
            ...
            <section className="banner pos-r p-0">
                ...
                <Row>
                    ...
                    {/* <div className="banner-slider owl-carousel no-pb h-100" data-dots="false" data-margin={5}> */}
                        ...
                        >
                        <div className="item bg-pos-rt"  style={{ backgroundImage: `url(${bg06})` }}>
                        ...
                        <div className="item bg-pos-rt" style={{ backgroundImage: `url(${bg05})` }}>
                            <Container className="h-100">
                            <Row className="h-100 align-items-center">
