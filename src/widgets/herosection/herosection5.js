...
import hero01 from '../../assets/images/furniture/hero/01.png';
                        ...
                        <Col lg={9}>
                            <Row className="align-items-center">
                                <Col lg={5} md={12} className="order-lg-1">
                                    <img className="img-fluid" src={hero01} alt="" />
                                </Col>
                                <Col lg={7} md={12} className="mt-5 mt-lg-0">
                                    <h6 className="font-w-6 text-primary animated3 mb-2">Welcome To Eastleigh Biz Hub</h6>
