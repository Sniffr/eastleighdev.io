...
import bg01 from '../../assets/images/kids/bg/01.jpg';
import bg02 from '../../assets/images/kids/bg/02.jpg';
        ...
        return (
            <section className="banner pos-r p-0">
                <OwlCarousel
                    ...
                    >
                    <div className="item bg-pos-rb" style={{ backgroundImage: `url(${bg01})` }}>
                        <Container className="h-100">
                            <Row className="h-100 align-items-center text-center">
                                <Col lg={6} md={12} className="custom-py-1 position-relative z-index-1">
                                    <h6 className="font-w-6 text-primary animated3">Welcome Eastleigh Kids</h6>
                    ...
                    <div className="item" style={{ backgroundImage: `url(${bg02})` }}>
                        <Container className="h-100">
                            <Row className="h-100 align-items-center text-center">
                                <Col lg={6} md={12} className="custom-py-1 position-relative z-index-1">
