...
import ad05 from "../../assets/images/product-ad/05.jpg";
import ad06 from "../../assets/images/product-ad/06.jpg";
            ...
            <Row>
                <div className="col-12 col-lg-6">
                    <div className="position-relative rounded overflow-hidden text-right shadow-sm">
                        {/* Background */}
                        <img className="img-fluid hover-zoom" src={ad05} alt="" />
                        {/* Body */}
                ...
                <div className="col-12 col-lg-6 mt-5 mt-lg-0">
                    <div className="position-relative rounded overflow-hidden text-right shadow-sm">
                        {/* Background */}
                        <img className="img-fluid hover-zoom" src={ad06} alt="" />
                        {/* Body */}
                        <div className="position-absolute top-50 pl-5 text-left">
