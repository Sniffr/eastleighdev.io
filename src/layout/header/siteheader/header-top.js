                ...
                <Container>
                    <Row className="align-items-center">
                        <Col md={12} className="d-flex align-items-center justify-content-between text-white">
                            <div className="d-none d-md-flex align-items-center"> <small className="mr-3"><i className="las la-store text-primary mr-1 align-middle" />Welcome to Eastleigh Business Hub</small>  <small><i className="las la-truck text-primary mr-1 align-middle" /> Free shipping Country Wide</small>
                            </div>
